package edu.ucsb.cs56.w14.drawings.dconard.simple;
...
/**
   ...
   @author Dwayne Conard (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManTopCircle = 
       ...
       g2.drawString("Top of snowman added by Dwayne Conard", 20,40);
    }
