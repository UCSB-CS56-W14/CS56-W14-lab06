package edu.ucsb.cs56.w14.drawings.jennyso.simple;
...
/**
   ...
   @author Jenny So (fixed the snowmans's head)
...
{  
   ...
   {  
	  ...
	  (
	   snowManCenterBottomX,
	   snowManCenterBottomY - 2*(bottomRadius + middleRadius) - topRadius,
	   topRadius
	   );
      g2.draw(snowManTopCircle);
       
       g2.drawString("A house and a snowman, by Phill Conrad", 20,20);
       g2.drawString("Top of snowman added by Jenny So", 20,40);
    }
