package edu.ucsb.cs56.w14.drawings.richard_wang.simple;
...
/**
   ...
   @author Richard Wang (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Richard Wang", 20,40);
    }
