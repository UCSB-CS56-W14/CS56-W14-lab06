package edu.ucsb.cs56.w14.drawings.alecharrell.simple;
...
/**
   ...
   @author Alec Harrell (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Alec Harrell", 20,40);
    }
