package edu.ucsb.cs56.w14.drawings.nissayeva.simple;
...
/**
   ...
   @author Natasha Issayeva (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Natasha Issayeva", 20,40);
    }
