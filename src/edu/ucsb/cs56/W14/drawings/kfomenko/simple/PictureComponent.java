package edu.ucsb.cs56.w14.drawings.kfomenko.simple;
...
/**
   ...
   @author Kateryna Fomenko (fixed the snowmans's head)
...
{  
   ...
   {  
     ...
     Circle snowManTopCircle = 
       ...
       g2.drawString("Top of snowman added by Katya Fomenko", 20,40);
    }
