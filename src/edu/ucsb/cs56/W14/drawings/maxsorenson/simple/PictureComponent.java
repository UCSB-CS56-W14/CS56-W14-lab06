package edu.ucsb.cs56.w14.drawings.maxsorenson.simple;
...
/**
   ...
   @author Max Sorenson (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Max Sorenson", 20,40);
    }
