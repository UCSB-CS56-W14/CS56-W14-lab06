package edu.ucsb.cs56.w14.drawings.khuu.simple;
...
/**
   ...
   @author Lesley Khuu (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       new Circle ( snowManCenterBottomX, snowManCenterBottomY - 2*(bottomRadius + middleRadius) - topRadius, topRadius );
       g2.draw(snowManTopCircle);
       
       // @@@ FINALLY, SIGN AND LABEL YOUR DRAWING
       
       g2.drawString("A house and a snowman, by Phill Conrad", 20,20);
       g2.drawString("Top of snowman added by Lesley Khuu", 20,40);
    }
