package edu.ucsb.cs56.w14.drawings.khalid.simple;
...
/**
   ...
   @author Khalid Dhanani (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Khalid Dhanani", 20,40);
    }
