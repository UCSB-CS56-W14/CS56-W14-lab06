package edu.ucsb.cs56.w14.drawings.edtropiax.simple;
...
/**
   ...
   @author Marcus Liou (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Marcus Liou", 20,40);
    }
