package edu.ucsb.cs56.w14.drawings.keithwaldron.simple;
...
/**
   ...
   @author Keith Waldron (fixed the snowmans's head)
...
{  
   ...
   {  
    ...
    Circle snowManTopCircle = 
       ...
       g2.drawString("Top of snowman added by Keith Waldron", 20,40);
    }
