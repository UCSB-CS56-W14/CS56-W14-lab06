package edu.ucsb.cs56.w14.drawings.vwtan.simple;
...
/**
   ...
   @author Vincent Tan (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
	   ...
	   (
	    snowManCenterBottomX,
	    snowManCenterBottomY - middleRadius * 2 - 2*bottomRadius -topRadius,
	    topRadius
	    );
       ...
       g2.drawString("Top of snowman added by Vincent Tan", 20,40);
    }
