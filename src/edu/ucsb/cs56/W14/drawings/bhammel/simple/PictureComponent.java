package edu.ucsb.cs56.w14.drawings.bhammel.simple;
...
/**
   ...
   @author Brandon Hammel (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      g2.draw( house);
       ...
       g2.drawString("Top of snowman added by Brandon Hammel", 20,40);
    }
}
