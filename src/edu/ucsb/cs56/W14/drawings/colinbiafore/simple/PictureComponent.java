package edu.ucsb.cs56.w14.drawings.colinbiafore.simple;
...
/**
   ...
   @author Colin Biafore (fixed the snowmans head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Colin Biafore", 20,40);
    }
