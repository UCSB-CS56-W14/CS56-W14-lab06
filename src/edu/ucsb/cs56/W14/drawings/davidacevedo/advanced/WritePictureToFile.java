...
public class WritePictureToFile
{
    public static void usage()
    {
       ...
       System.out.println(" whichImage should be 1. a bunch of random donuts,2. lots more bunch of random donuts or 3. a sort of triforce of donuts that are green, blue, and red");
    ...
    /** Write the drawFourDonuts picture to a file.
     * 
