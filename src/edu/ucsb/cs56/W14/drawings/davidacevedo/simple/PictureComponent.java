package edu.ucsb.cs56.w14.drawings.davidacevedo.simple;
...
/**
   ...
   @author David Acevedo (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManTopCircle = 
       ...
       g2.drawString("Top of snowman added by David Acevedo", 20,40);
    }
