...
public class AllMyDrawings
{
	...
	// Draw two Boxes with marks
	
	BoxWithMark bm1 = new BoxWithMark(55, 500,60,50);
	BoxWithMark bm2 = new BoxWithMark(100, 30, 25, 50);
	...
	g2.drawString("A few boxes by Bonan Yan", 20,20);
    }
