package edu.ucsb.cs56.w14.drawings.m_iskander.simple;
...
/**
   ...
   @author Mena Iskander (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Mena Iskander", 20,40);
    }
