package edu.ucsb.cs56.w14.drawings.vlara.simple;
...
/**
   ...
   @author Vincente Lara (fixed the snowmans's head)
...
{  
   ...
   {  
	  ...
	  (
       ...
       g2.drawString("Top of snowman added by Vincente Lara", 20,40);
    }
