package edu.ucsb.cs56.w14.drawings.loganortega.simple;
...
/**
   ...
   @author Logan Ortega (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Logan Ortega", 20,40);
    }
