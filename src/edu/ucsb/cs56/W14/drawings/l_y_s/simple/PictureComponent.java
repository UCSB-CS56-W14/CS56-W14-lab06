package edu.ucsb.cs56.w14.drawings.l_y_s.simple;
...
/**
   ...
   @author Logan Schmidt (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Logan Schmidt", 20,40);
    }
