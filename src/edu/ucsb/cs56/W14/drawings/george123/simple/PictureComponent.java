package edu.ucsb.cs56.w14.drawings.george123.simple;
...
/**
   ...
   @author George Chen (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      g2.draw(snowManTopCircle);
       ...
       g2.drawString("Top of snowman added by George Chen", 20,40);
    }
