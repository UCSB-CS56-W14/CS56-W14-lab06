package edu.ucsb.cs56.w14.drawings.rtwaltman.simple;
...
/**
   ...
   @author Richard Waltman (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Richard Waltman", 20,40);
    }
