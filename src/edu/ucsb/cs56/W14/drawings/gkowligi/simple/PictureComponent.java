package edu.ucsb.cs56.w14.drawings.gkowligi.simple;
...
/**
   ...
   @author Girish Kowligi (fixed the snowmans's head)
...
{  
   ...
   {  
	...
	g2.draw(snowManTopCircle);
       ...
       g2.drawString("Top of snowman added by Girish Kowligi", 20,40);
    }
