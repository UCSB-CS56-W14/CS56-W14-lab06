package edu.ucsb.cs56.w14.drawings.andrewpang.simple;
...
/**
   ...
   @author Andrew Pang (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Andrew Pang", 20,40);
    }
