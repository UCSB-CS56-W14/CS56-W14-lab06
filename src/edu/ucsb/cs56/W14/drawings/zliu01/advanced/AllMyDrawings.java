...
public class AllMyDrawings
{
	...
	MobilePhone p1 = new MobilePhone(50,50,50,150);
	g2.setColor(Color.CYAN); g2.draw(p1);
	
	// Make a black mobilephone that's half the size, 
	...
	// Here's a mobilephone that's 4x as big (2x the original)
	...
	iPhone ip1 = new iPhone(350,100,50,150);
	iPhone ip2 = new iPhone(250,150,100,250);
	...
	g2.drawString("A few phones by Zhe Liu", 20,20);
    }
