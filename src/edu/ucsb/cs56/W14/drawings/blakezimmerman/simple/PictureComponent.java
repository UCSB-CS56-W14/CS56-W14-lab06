package edu.ucsb.cs56.w14.drawings.blakezimmerman.simple;
...
/**
   A component that draws a Picture by Phill Conrad and Blake Zimmerman
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Blake Zimmerman", 20,40);
    }
