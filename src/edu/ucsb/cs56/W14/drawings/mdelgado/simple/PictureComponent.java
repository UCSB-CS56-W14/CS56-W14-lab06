package edu.ucsb.cs56.w14.drawings.mdelgado.simple;
...
/**
   ...
   @author Miguel Delgado (fixed the snowmans's head)
...
{  
   ...
   {  
	...
	g2.draw(snowManTopCircle);
       ...
       g2.drawString("Top of snowman added by Miguel Delgado", 20,40);
    }
